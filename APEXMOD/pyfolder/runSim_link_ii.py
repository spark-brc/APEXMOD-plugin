...
def create_apexmf_link(
    ...
    if self.dlg.checkBox_printing_m_a.isChecked():
        printing_m_a = "1    Printing out monthly and annual average APEX-MODFLOW outputs\r\n"
    else:
        printing_m_a = "0    Printing out monthly and annual average APEX-MODFLOW outputs\r\n"
    lines = []
    with open(infile, 'r') as f:
        for line in f:
            ...
            if line.startswith('0    Printing out monthly and annual average APEX-MODFLOW outputs'):
                line = printing_m_a
