...
class ModflowSfr2(Package):
    ...
    def export(self, f, **kwargs):
        if isinstance(f, str) and f.lower().endswith(".shp"):
            from APEXMOD.modules.flopy.utils.geometry import Polygon
            from APEXMOD.modules.flopy.export.shapefile_utils import recarray2shp
            ...
            from APEXMOD.modules.flopy import export
    ...
    def export_linkages(self, f, **kwargs):
        ...
        """
        from APEXMOD.modules.flopy.utils.geometry import LineString
        from APEXMOD.modules.flopy.export.shapefile_utils import recarray2shp
    ...
    def export_outlets(self, f, **kwargs):
        ...
        """
        from APEXMOD.modules.flopy.utils.geometry import Point
        from APEXMOD.modules.flopy.export.shapefile_utils import recarray2shp
        rd = self.reach_data
