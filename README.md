...
- __[Installer](https://github.com/spark-brc/APEXMOD/releases/download/v1.4.2/APEXMOD.exe):__ APEXMOD 1.4.exe
- **[Inputs](https://github.com/spark-brc/APEXMOD/releases/download/v1.4.2/apexmod_data.zip):** Animas Dataset zip file
...
- Download [the APEXMOD installer](https://github.com/spark-brc/APEXMOD/releases/download/v1.4.2/APEXMOD.exe) and install it by running APEXMOD 1.0.exe or a later version. The APEXMOD is installed into the user's home directory *(~\AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins\APEXMOD)*, which we will refer to as the APEXMOD plugin directory.
